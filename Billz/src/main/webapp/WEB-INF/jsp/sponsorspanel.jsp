...
<link href="<c:url value="/resources/css/sponsor.css"/>" rel="stylesheet">
	...
	<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="<c:url value="/Logout"/>" class="navbar-brand" href="#"
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <div class="h6 text-muted">Lost</div>
